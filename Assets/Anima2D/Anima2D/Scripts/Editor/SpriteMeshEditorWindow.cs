...
namespace Anima2D 
{
	...
	{		
		...
		bool GetLinearSampled(Texture2D texture)
		{
			...
			MethodInfo methodInfo = typeof(UnityEditor.Editor).Assembly.GetType("UnityEditor.TextureUtil").GetMethod("GetLinearSampled", BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
