...
namespace Anima2D 
{
	...
	public class SpriteMeshEditor : UnityEditor.Editor
	{
		...
		Texture2D BuildPreviewTexture(int width, int height, Sprite sprite, Material spriteRendererMaterial)
		{
			...
			MethodInfo methodInfo = typeof(UnityEditor.Editor).Assembly.GetType("UnityEditor.SpriteInspector").GetMethod("BuildPreviewTexture", BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
		...
		public static void DrawPreview(Rect r, Sprite frame, Material spriteRendererMaterial)
		{
			...
			MethodInfo methodInfo = typeof(UnityEditor.Editor).Assembly.GetType("UnityEditor.SpriteInspector").GetMethod("DrawPreview", BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
